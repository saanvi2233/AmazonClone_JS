...
constructor(productDetails){
  // super helps to call the contructor of the parent class
  // if no contructor it runs the class contructor
...
// instead of typing new product manualy we will loop through the array
